...
public class Sync {
     ...
     */
    public static String[] responseUser = new String[2];
    ...
    public static void responseRetun(String success, String failure) {
        responseUser[0] = success;
        responseUser[1] = failure;
    }

    public static String[] callLoginAPI(Context context) {
        WSManager wsManager;
        User user;
        StringEntity entity;
        ...
        return responseUser;
        /**
         * responseUser[0]=success response
         * responseUser[1]=fail fail response
         * */
    }
    ...
    public static Object[] syncSchoolTableTen(Context context, SQLiteDatabase db, String url) {
        ...
        if (json == null) {
            ...
            if (H.isHTMLresponse(json)) {
                ...
                objects[0] = countHTML;
                objects[1] = schoolListModel;
                schoolModels = (ArrayList<SchoolModel>) schoolListModel.getModel();
            ...
            if (H.isHTMLresponse(json)) {
                ...
                for (int i = 0; i < noOfModels; i++) {
                    ...
                    if (!ids.contains(id)) {
                        ...
                        jsonDetail = Sync.callApiGET(context, API.urlTeacherby_id + id);
