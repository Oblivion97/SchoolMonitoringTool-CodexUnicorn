...
import com.example.f.schMon.view.paymentsWithTab.salary.SalaryFrag;

import java.util.ArrayList;
import java.util.List;

public class PaymentActivityTabSch extends AppCompatActivity implements FeeSchFrag.OnFragmentInteractionListener {
    private final String TAG = PaymentActivityTabSch.class.getName();
    private final Context context = PaymentActivityTabSch.this;
...
// __________ nav drawer close on back button click ____________________
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_payment_tab_sch);
        ...
        if (DAO.isTableEmpty(db, DB.schools.table)
                && DAO.isTableEmpty(db, DB.teachers.table)) {
    ...
    public void setViewPagerAdapter(ViewPager viewPager) {
        ...
        viewPagerAdapter.addFragment(com.example.f.schMon.view.paymentsWithTab.feeSch.FeeSchFrag.newInstance("", ""), "Fee Collection");
        viewPagerAdapter.addFragment(SalaryFrag.newInstance("", ""), "Teacher's Salary");
